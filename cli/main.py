...
app.add_typer(generate_app, name="generate", help="Generate content with fine-tuned models")
...
def status() -> None:
    ...
    console.print("• [cyan]ghostwriter generate text <author>[/cyan] - Generate content")
