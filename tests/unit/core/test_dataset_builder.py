...
class TestDatasetBuilder:
    ...
    def test_init_with_existing_dataset(self, temp_data_dir, mock_settings, sample_dataset):
...
"""
    ...
    def test_add_from_writing_samples(self, mock_prompt, mock_console, temp_data_dir, mock_settings):
    ...
    @patch('core.dataset.builder.console')
    @patch('core.dataset.builder.Prompt')
    def test_add_from_writing_samples_empty_input(self, mock_prompt, mock_console, temp_data_dir, mock_settings):
    ...
    @patch('core.dataset.builder.console')
    @patch('core.dataset.builder.Prompt')
    def test_add_from_writing_samples_empty_prompt(self, mock_prompt, mock_console, temp_data_dir, mock_settings):
    ...
    @patch('core.dataset.builder.console')
    @patch('core.dataset.builder.Prompt')
    @patch('core.prompts.templates.EXAMPLE_GENERATION_PROMPTS', {
    ...
    def test_generate_examples(self, mock_prompt, mock_console, temp_data_dir, mock_settings):
    ...
    @patch('core.dataset.builder.console')
    @patch('core.dataset.builder.Prompt')
    def test_generate_examples_empty_response(self, mock_prompt, mock_console, temp_data_dir, mock_settings):
        ...
        with patch('core.storage.settings', mock_settings):
            ...
            with patch('core.dataset.builder.EXAMPLE_GENERATION_PROMPTS', {'test': 'Test prompt'}):
                builder._generate_examples()
    ...
    @patch('builtins.open', new_callable=mock_open, read_data="First paragraph.\n\nSecond paragraph.")
    @patch('core.dataset.builder.Path')
    def test_import_from_file(self, mock_path_class, mock_file, mock_confirm, mock_prompt, mock_console, 
                              temp_data_dir, mock_settings):
    ...
    @patch('core.dataset.builder.Prompt')
    @patch('core.dataset.builder.Path')
    def test_import_from_file_not_exists(self, mock_path_class, mock_prompt, mock_console, temp_data_dir, mock_settings):
        ...
        with patch('core.storage.settings', mock_settings):
            ...
            # Should not add any examples
            assert builder.dataset.size == initial_size
            mock_console.print.assert_called_with("[red]File not found: /nonexistent/file.txt[/red]")
    
    @patch('core.dataset.builder.console')
    @patch('core.dataset.builder.Prompt')
    @patch('builtins.open', new_callable=mock_open, read_data="")
    @patch('core.dataset.builder.Path')
    def test_import_from_file_empty(self, mock_path_class, mock_file, mock_prompt, mock_console, 
                                   temp_data_dir, mock_settings):
    ...
    @patch('core.dataset.builder.Path')
    def test_import_from_file_read_error(self, mock_path_class, mock_file, mock_prompt, mock_console,
                                        temp_data_dir, mock_settings):
        ...
        with patch('core.storage.settings', mock_settings):
            ...
            mock_console.print.assert_called_with("[red]Error reading file: Permission denied[/red]")
    ...
    @patch('core.dataset.builder.console')
    def test_review_dataset_with_examples(self, mock_console, temp_data_dir, mock_settings, sample_training_examples):
    ...
    def test_save_and_exit_empty(self, mock_console, temp_data_dir, mock_settings):
        ...
        with patch('core.storage.settings', mock_settings):
            ...
            mock_console.print.assert_called_with("[yellow]No examples to save[/yellow]")
    
    @patch('core.dataset.builder.console')
    def test_save_and_exit_with_examples(self, mock_console, temp_data_dir, mock_settings, sample_training_examples):
        ...
        with patch('core.storage.settings', mock_settings):
            ...
            mock_console.print.assert_any_call(f"[green]Saved {len(sample_training_examples)} examples to {expected_path}[/green]")
    
    @patch('core.dataset.builder.console')
    def test_save_and_exit_recommendations(self, mock_console, temp_data_dir, mock_settings):
        ...
        with patch('core.storage.settings', mock_settings):
            ...
            mock_console.print.assert_any_call("[yellow]Recommendation: Add more examples (10-100) for better fine-tuning results[/yellow]")
            ...
            mock_console.print.assert_any_call("[green]Great! You have enough examples for effective fine-tuning[/green]")
...
Another long paragraph that should not be filtered out because it has enough content to be meaningful."""
            ...
            with patch('core.dataset.builder.Confirm.ask', side_effect=[True, True]) as mock_confirm, \
                 patch('core.dataset.builder.Prompt.ask', side_effect=["prompt1", "prompt2"]) as mock_prompt:
...
class TestDatasetBuilderIntegration:
    ...
    @patch('core.dataset.builder.Prompt')
    @patch('core.dataset.builder.Confirm')
    def test_full_workflow_simulation(self, mock_confirm, mock_prompt, mock_console, temp_data_dir, mock_settings):
        ...
        with patch('core.storage.settings', mock_settings):
            ...
            assert "Sample content for testing" in loaded_dataset.examples[0].messages[2]["content"]