...
class TestOpenAIAdapterFileUpload:
    ...
    def test_upload_training_file_content(self, mock_file_open, mock_tempfile, mock_openai_client, sample_dataset):
    ...
    def test_upload_training_file_cleanup(self, mock_path, mock_openai_client, sample_dataset):
...
class TestOpenAIAdapterJobStatus:
    ...
    def test_get_job_status_success(self, mock_openai_client):
        ...
        with patch('core.adapters.openai_adapter.settings') as mock_settings:
            ...
            with patch('openai.OpenAI', return_value=mock_openai_client):
                ...
                assert status_info["fine_tuned_model"] == "ft:gpt-3.5-turbo:test:test-model:123"
    ...
    def test_get_job_status_api_error(self, mock_openai_client):
        ...
        mock_openai_client.fine_tuning.jobs.retrieve.side_effect = Exception("API Error")
    ...
    def test_update_job_status(self, mock_openai_client, sample_fine_tune_job):
        ...
        with patch('core.adapters.openai_adapter.settings') as mock_settings:
            ...
            with patch('openai.OpenAI', return_value=mock_openai_client):
                ...
                assert updated_job.fine_tuned_model == "ft:gpt-3.5-turbo:test:test-model:123"
...
class TestOpenAIAdapterWaitForCompletion:
    ...
    def test_wait_for_completion_success(self, mock_progress, mock_sleep, mock_openai_client, sample_fine_tune_job):
        ...
        with patch('core.adapters.openai_adapter.settings') as mock_settings:
            ...
            with patch('openai.OpenAI', return_value=mock_openai_client):
                ...
                final_job = adapter.wait_for_completion(sample_fine_tune_job, check_interval=1)
    ...
    @patch('time.sleep')
    @patch('core.adapters.openai_adapter.Progress')
    def test_wait_for_completion_failure(self, mock_progress, mock_sleep, mock_openai_client, sample_fine_tune_job):
    ...
    @patch('time.sleep')
    @patch('core.adapters.openai_adapter.Progress')
    def test_wait_for_completion_cancelled(self, mock_progress, mock_sleep, mock_openai_client, sample_fine_tune_job):
...
class TestOpenAIAdapterModelTesting:
    ...
    def test_test_fine_tuned_model_default_prompts(self, mock_console, mock_openai_client):
    ...
    @patch('core.adapters.openai_adapter.console')
    def test_test_fine_tuned_model_custom_prompts(self, mock_console, mock_openai_client):
