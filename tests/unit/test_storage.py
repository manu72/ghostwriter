...
class TestAuthorStorage:
    ...
    def test_init_creates_directory(self, temp_data_dir, mock_settings):
        ...
        with patch('core.storage.settings', mock_settings):
            storage = AuthorStorage("new_author")
    ...
    def test_load_profile(self, temp_data_dir, mock_settings, sample_author_profile):
        ...
        with patch('core.storage.settings', mock_settings):
            ...
            assert loaded_profile.style_guide.tone == sample_author_profile.style_guide.tone
    ...
    def test_save_model_metadata(self, temp_data_dir, mock_settings, sample_model_metadata):
        ...
        with patch('core.storage.settings', mock_settings):
            ...
            assert len(metadata_data['fine_tune_jobs']) == len(sample_model_metadata.fine_tune_jobs)
            assert metadata_data['active_model'] == sample_model_metadata.active_model
    
    def test_load_model_metadata(self, temp_data_dir, mock_settings, sample_model_metadata):
        ...
        with patch('core.storage.settings', mock_settings):
            ...
            assert len(loaded_metadata.fine_tune_jobs) == len(sample_model_metadata.fine_tune_jobs)
    ...
    def test_file_permissions_error(self, temp_data_dir, mock_settings, sample_author_profile):
    ...
    def test_json_serialization_error(self, temp_data_dir, mock_settings, sample_author_profile):
...
class TestModuleFunctions:
    ...
    def test_list_authors_directory_without_profiles(self, temp_data_dir, mock_settings):
    ...
    def test_list_authors_mixed(self, temp_data_dir, mock_settings, sample_author_profile):
    ...
    def test_get_author_profile(self, temp_data_dir, mock_settings, sample_author_profile):
...
class TestStorageIntegration:
    ...
    def test_full_author_workflow(self, temp_data_dir, mock_settings, sample_author_profile, 
                                  sample_dataset, sample_model_metadata):
    ...
    def test_concurrent_access(self, temp_data_dir, mock_settings, sample_author_profile):
    ...
    def test_data_persistence_across_instances(self, temp_data_dir, mock_settings, sample_author_profile):
